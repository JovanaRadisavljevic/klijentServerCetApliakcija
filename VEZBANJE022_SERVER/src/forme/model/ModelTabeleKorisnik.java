...
public class ModelTabeleKorisnik extends AbstractTableModel{
   ...
   private String[] kolone = {"id", "username","prijavljen"};
   private List<User> prijavljeniKorisnici = controller.Controller.getInstance().getUlogovaniKorisnici();
   ...
   @Override
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                if(prijavljeniKorisnici.contains(p))
                    return "DA";
                else
                    return "NE";
